...
def generate_contracts_schema_description():
    ...
    schema_description += "- contracts_contractpackaging.contract_id (OneToOne) refers to contracts_contract.id (CASCADE)\n"
    schema_description += "- contracts_contractpackaging.packhouse_id (FK) refers to contracts_supplier.id (PROTECT)\n"
    schema_description += "- contracts_contractpackaging.created_by_id (FK) refers to auth_user.id\n"
    schema_description += "- contracts_contractpackaging.modified_by_id (FK) refers to auth_user.id\n"
    ...
    schema_description += "- contracts_contact_categories links contacts to global SupplierContactCategory rows (Primary, Contracts, Sales, etc.)\n"
