...
## 19. Quick Reference
- Primary models: `Supplier`, `Contact`, `SupplierContactCategory`, `SupplierCertification`, `SupplierClassification`, `SupplierDocument`, `OpenRouterModelSetting`.
