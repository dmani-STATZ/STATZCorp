...
- This app does not define its own Django `forms.py`; `contracts.forms.SupplierForm` powers the create/edit forms rendered by the `suppliers` templates.
