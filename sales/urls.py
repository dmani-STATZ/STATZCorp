...
urlpatterns = [
    ...
    path(
        "solicitations/saved-filters/create/",
        saved_filter_create,
        name="saved_filter_create",
    ),
    path(
        "solicitations/saved-filters/update/",
        saved_filter_update,
        name="saved_filter_update",
    ),
    path(
        "solicitations/saved-filters/delete/",
        saved_filter_delete,
        name="saved_filter_delete",
    ),
    path(
        "solicitations/saved-filters/share/",
        saved_filter_share,
        name="saved_filter_share",
    ),
    path("solicitations/research-pool/", research_pool_list, name="research_pool_list"),
    path("solicitations/mass-pass/", sol_mass_pass, name="sol_mass_pass"),
    path("solicitations/mass-pass/history/", mass_pass_history, name="mass_pass_history"),
    path(
        "solicitations/mass-pass/undo/<int:log_pk>/",
        mass_pass_undo,
        name="mass_pass_undo",
    ),
    path("solicitations/review/", sol_review_queue, name="sol_review_queue"),
    path("solicitations/review/<int:sol_pk>/", sol_review_legacy_redirect, name="sol_review_decision"),
    ...
    path(
        ...
        solicitation_history_packaging_partial,
        name="solicitation_history_packaging_partial",
    ),
    path(
    ...
    path(
        ...
        solicitation_workbench_sidebar_partial,
        name="solicitation_workbench_sidebar_partial",
    ),
    path("solicitations/<str:sol_number>/unbid/", sol_unbid, name="sol_unbid"),
    path("solicitations/<str:sol_number>/", solicitation_workbench, name="solicitation_detail"),
    ...
    path("rfq/manual-queue-add/", rfq_queue_add_manual, name="rfq_queue_add_manual"),
