...
def settings_cage_add(request):
    ...
    context = {
        'cage': None,
        'action': 'Add',
        'affirmative_choices': [('Y6', 'Has'), ('N6', 'Has Not'), ('NH', 'Not Applicable'), ('NA', 'NA')],
        'prev_contracts_choices': [('Y4', 'Yes >$10K'), ('Y5', 'Yes >$25K'), ('N4', 'No'), ('NA', 'NA')],
    }
...
def _cage_from_post(data, instance=None):
    ...
    cage.sb_representations_code = data.get('sb_representations_code', 'B').strip()
    ...
    cage.alternate_disputes_resolution = data.get('alternate_disputes_resolution', 'A').strip()
